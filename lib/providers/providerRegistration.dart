...
import 'package:jobhunt/providers/jobproviderDashBoard.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';
import 'package:fluttertoast/fluttertoast.dart';
import 'dart:io';

import 'package:jobhunt/providers/providerhomescreen.dart';
...
class _SellerRegisterPageState extends State<SellerRegisterPage> {
  ...
  void initState() {
    ...
    this._websiteController = new TextEditingController();
...
await getImage();
        ...
        _entryField("Website", controllervar: _websiteController),
      ],
      );
  }
